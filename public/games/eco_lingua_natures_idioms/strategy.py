...
class EcoLinguaNaturesIdiomsStrategy(BaseStrategy):
    _strategy_name = "eco_lingua_natures_idioms"
    ...
    def __init__(self, game_name: str, config: dict, assets_path: str, **kwargs):
        ...
        self.rounds = []  # Will be loaded from assets
    ...
    def _display_current(self):
        ...
        # Each round has 6 text entries mapped to faces
